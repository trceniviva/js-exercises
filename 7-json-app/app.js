...
grungeAlbums = JSON.parse(grungeAlbumsJSON)
...
for (i = 0; i < grungeAlbums.albums.length; i++) {
    console.log("Album: " + grungeAlbums.albums[i].name);
    console.log("Album: " + grungeAlbums.albums[i].artist);
    console.log("Album: " + grungeAlbums.albums[i].unitsSold);
}
